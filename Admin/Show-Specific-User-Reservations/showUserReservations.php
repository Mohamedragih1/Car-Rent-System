<?php
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $userReservationInfo[] = $reservationDetails;
    }

    session_start();

    // Store the array in the session variable
    $_SESSION['userReservationInfo'] = $userReservationInfo;

    header("Location: viewUserReservations.php");
    exit();
} else {
